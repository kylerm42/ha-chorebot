 ...
 * - Task editing dialog
 */
let ChoreBotListCard = class ChoreBotListCard extends i {
    constructor() {
        super(...arguments);
    ...
    _renderTasks(tasks) {
        if (tasks.length === 0) {
            return x `<div class="empty-state">No tasks for today</div>`;
        }
    ...
    _playCompletionConfetti(origin) {
        ...
        const baseColor = this._config.task_background_color || "var(--primary-color)";
        ...
        return {
            ...
            computeHelper: (schema) => {
                const helpers = {
                    ...
                    task_background_color: "Background color for task items (hex code or CSS variable like var(--primary-color))",
...
__decorate([
    n({ attribute: false })
], ChoreBotListCard.prototype, "hass", void 0);
__decorate([
    r()
], ChoreBotListCard.prototype, "_config", void 0);
__decorate([
    r()
], ChoreBotListCard.prototype, "_editDialogOpen", void 0);
__decorate([
    r()
], ChoreBotListCard.prototype, "_editingTask", void 0);
__decorate([
    r()
], ChoreBotListCard.prototype, "_saving", void 0);
ChoreBotListCard = __decorate([
    t("chorebot-list-card")
], ChoreBotListCard);
...
export { ChoreBotListCard };
//# sourceMappingURL=chorebot-list-card.js.map
